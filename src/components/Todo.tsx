...
function Todo() {
    ...
    return (
        <div className='main'>
            ...
            {isConnected && chainId === 31337 && hash && (
                <div className='item'>
                    <Tooltip title={hash}>
            ...
            {isConnected && chainId === 31337 && isConfirming && (
                <div className='item'>
            ...
            {isConnected && chainId === 31337 && isConfirmed && (
                <div className='item'>
        ...
        <div className='item'>
          <span className='error'>错误回调: {(error as BaseError).shortMessage || error.message}</span>
            ...
            <div className="total">
                <Table loading={loading} columns={columns} dataSource={isConnected && chainId === 31337 ? todoList : []} pagination={{ pageSize: 6, showTotal }} />
            </div>
        </div>
    )
}
